...
let dealerCards = [];  // Arrays holding the DisplayCard objects used to show the cards
let playerCards = [];
...
let standButton, hitButton, newGameButton;  // objects representing the buttons, so I can enable/disable them
...
function dealersTurnAndEndGame() {
    ...
    dealerCards[2].cardContainer.style.display = "none";
    dealerCards[2].setFaceUp();
    let takeNextCardOrFinish = function() {
